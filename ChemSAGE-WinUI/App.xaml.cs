    ...
    public App()
    {
        ...
        _host = Host.CreateDefaultBuilder()
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<IResourceService>(sp => new ResourceService(sp.GetRequiredService<IHttpClientFactory>().CreateClient("Supabase"), sp.GetRequiredService<Microsoft.Extensions.Options.IOptions<SupabaseOptions>>()));
                services.AddSingleton<IPastPaperService>(sp => new PastPaperService(sp.GetRequiredService<IHttpClientFactory>().CreateClient("Supabase"), sp.GetRequiredService<Microsoft.Extensions.Options.IOptions<SupabaseOptions>>()));
